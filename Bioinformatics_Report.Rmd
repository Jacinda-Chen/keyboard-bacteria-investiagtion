...
**Figure 9:** Boxplot of Shannon alpha diversity metrics according to sample type. The mean number of the alpha diversity measures were not significantly different between sample groups for Shannon and Simpson (Table 12 Wilcox p = 0.7; Table 13 Wilcox p = 0.7).
...
**Table 12:** The statistical (Wilcox) test of Shannon's diversity to compare the richness component of diversity between Communal and Individual computer keyboards, positive controls, and negative controls.

```{r Wilcox-test-using-simpson-diversity}
...
# wilcox p = 0.7
wilcox.test(data = combined_simpson,
            jc_simpson_div ~ jc_group_2)
```

**Table 13:** The statistical (Wilcox) test of Simpson's diversity to compare the evenness component of diversity between Communal and Individual computer keyboards, positive controls, and negative controls.
...
**Figure 11:** Summary boxplot of summary abundance for each Genus.
...
**Figure 12:** Figure of abundance summary for each Phylum.
