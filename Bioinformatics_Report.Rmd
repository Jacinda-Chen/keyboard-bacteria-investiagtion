...
culture_free_data %>%
  ...
  ylab("Species Count")
```
**Figure 7:** Boxplot showing the number of different species between Communal and Individual samples. The mean number of different species were not significantly different between sample groups (Wilcox p = 0.7).
...
I discovered that the majority of the Cultured BLAST species were found in the Culture-Free BLAST results. *Staphylococcus hominis* was the only species that was not found in the Culture-Free BLAST results for Sample 2A. Since no culture was grown for Sample 4A, there was nothing to compare with the Culture-Free BLAST results.
...
It was found that the most abundant and the second most abundant species found for the positive controls were all the same: *Salmonella enterica* subsp. *enterica serovar Indiana* and *Listeria monocytogenes* (Table 10). The negative controls obtained a variety of the second most abundant species (Table 10).
...
**Table 11:** BLAST Table of the most abundant and second-most abundant species in the positive and negative controls.
