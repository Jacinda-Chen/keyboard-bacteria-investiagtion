...
The surface samples were collected during the lab section of the Bioinformatics class on September 3rd, 2019. In total, twelve tubes were collected (two tubes per sample in four different locations). For each location, two different keys on the keyboard was swabbed. Each sterile swab was dipped in sterile PBS (Phosphate Buffer Saline at pH 7.4)to moisten, then wrung of excess PBS against the side of the tube. The surface was then swabbed for 15 seconds. The tip of the swab was broken off into a labelled eppendorf. Samples were gathered first in the first floor of Toler Hall, where one sample was gathered for the "A" key and another two samples were gathered for the "F" key on the shared computer at the front desk. The exact same procedure was repeated for the next three locations:one, on the fourth floor of the University Center, specifically in the graphics center on a shared computer;two, on the first floor of the library, where samples were gathered on a shared computer; and three, inside the Bioinformatics class where samples were gathered from three different laptops.
