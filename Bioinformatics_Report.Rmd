...
```{r make-a-shannon-diversity-figure}
...
```{r make-a-summary-table-of-sequence-counts-per-Phylum}
...
```{r make-a-figure-of-abundance-summary-per-Phylum}
