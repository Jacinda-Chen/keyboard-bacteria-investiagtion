...
plot_bar(phyloseq_obj,
         x = "type",
         fill = "Phylum",
         title = "Variety of Phyla per Sample Group")
```
...
melted_phyloseq %>%
  ...
  ggtitle(
    "Sum Abundance of the Top Five genera in Sample Groups")
```
...
melted_phyloseq %>%
  ...
  theme(axis.text.x = element_text(angle = 45,
                                   ...
                                   vjust = 1)) +
  ggtitle(
    "Mean Abundance of phyla in Sample Groups")
```
