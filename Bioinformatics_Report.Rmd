...
**Table 1** is a statistical (Wilcox) test to compare the number of colony abundances of Communal versus Individual computers at 1x dilution. 
...
### Table with the locus of each sequence (16S), original filename of each sequence, the filename after correcting....

**Table 4:** Corrected/accepted sequences of samples
