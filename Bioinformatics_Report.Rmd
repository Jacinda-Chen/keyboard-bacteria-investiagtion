...
Dilution Series: I split the samples into two groups: key "A" and key "F". The "A" key group was put directly into the freezer at -20^o Celcius so data could be extracted directly from those samples. The dilution series was done with the "F" key group. Since it was not known what type of bacteria it was nor how much of it would grow, it was necessary to dilute the samples in order to maximize the number of environments that the bacteria could possibly grow in.
