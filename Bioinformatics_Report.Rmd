...
The mean number of morphotypes between Communal and Individual computer keyboards were not sigficant with a p-value of 0.10 (Table 2; Statistical test on the number of morphotypes). This was the result of a statistical test to compare the number of morphotypes in Communal versus Individual computer. 
